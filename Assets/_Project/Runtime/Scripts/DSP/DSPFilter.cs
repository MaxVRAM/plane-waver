...
namespace PlaneWaver.DSP
{
    ...
    public class DSPFilter : DSPClass
    {
        ...
        {
            LowPass, HiPass, BandPass, PeakNotch, None
        }

        [Range(0f, 1f)] [SerializeField] public float _Mix = 1;

        [SerializeField] public FilterType _FilterType;

        [Range(0f, 1f)] [SerializeField] float _FilterCutoffNorm = 0.5f;

        [Range(0.05f, 1)] [SerializeField] float _FilterGain = 1;

        [Range(0.1f, 5)] [SerializeField] float _FilterQ = 1;
        ...
        public override AudioEffectParameters GetDSPBufferElement()
        {
            ...
            audioEffectParams.AudioEffectType = AudioEffectTypes.Filter;
            audioEffectParams.SampleRate = _SampleRate;
            audioEffectParams.Mix = _Mix;
            audioEffectParams.Value0 = newCoefficients.a0;
            audioEffectParams.Value1 = newCoefficients.a1;
            audioEffectParams.Value2 = newCoefficients.a2;
            audioEffectParams.Value3 = newCoefficients.b1;
            audioEffectParams.Value4 = newCoefficients.b2;
            ...
            DynamicBuffer<DSPSampleBufferElement> dspBuffer)
        {
            ...
            for (int i = 0; i < sampleBuffer.Length; i++)
            {
                ...
                outputSample
                        = (sampleBuffer[i].Value * audioEffectParams.Value0 +
