...
namespace PlaneWaver
{
    ...
    public abstract class EmitterAuthoring : SynthElement
    {
        ...
        protected void UpdateDSPEffectsBuffer(bool clear = true)
        {
            ...
            DynamicBuffer<AudioEffectParameters> dspBuffer = Manager.GetBuffer<AudioEffectParameters>(ElementEntity);
        ...
        public void NewCollision(Collision collision)
        {
            ...
            {
                if (Time.fixedTime < _LastTriggeredAt + GrainBrain.Instance.BurstDebounceDurationMS * 0.001f)
                    return;
        ...
        protected bool OnlyTriggerMostRigid => GrainBrain.Instance.OnlyTriggerMostRigidSurface;
