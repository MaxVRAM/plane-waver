...
public class DebugGUI_FPS : MonoBehaviour
{
    /* * * *
     * 
     *   [DebugGUIGraph]
     *   Renders the variable in a graph on-screen. Attribute based graphs will updates every Tick.
...
//    float mouseY;
    ...
    void Awake()
    {
        ...
        DebugGUI.SetGraphProperties("smoothFrameRate", "SmoothFPS", 0, 200, 0, new Color(0, 1, 1), true);
        //DebugGUI.SetGraphProperties("frameRate", "FPS", 0, 200, 0, new Color(1, 0.5f, 1), true);
    ...
    void Update()
    {
        ...
        DebugGUI.LogPersistent("smoothFrameRate", "SmoothFPS: " + (1 / Time.deltaTime).ToString("F1"));
